...
export interface Messages {
  ...
  dashboard: {
    ...
    contentDeleteTitle: string;
    contentDeleteBody: string;
    contentDeleteConfirm: string;
    contentDeleteCancel: string;
    ...
    blogSubtitle: string;
    blogNewPost: string;
    blogColAuthor: string;
    blogColCategory: string;
    blogColPublished: string;
    blogExcerpt: string;
    blogBody: string;
    blogCover: string;
    blogCategory: string;
    ...
    contentTemplateMarketing: string;
    contentTemplateBlank: string;
    contentTemplatePage: string;
    contentViewCubes: string;
    contentViewTable: string;
    contentCubesTitle: string;
    contentCubesBody: string;
    contentCubeCount: string;
    contentCubeOpen: string;
    contentTemplateFilterAll: string;
    save: string;
    saving: string;
    saved: string;
    mediaTitle: string;
  ...
  cmsBuilder: {
    ...
    menuMoveUp: string;
    menuMoveDown: string;
    menuEditContent: string;
    menuInspectProps: string;
    menuInspectStyle: string;
    menuCopyStyles: string;
    menuPasteStyles: string;
    menuSaveReusable: string;
    menuKbdEdit: string;
    menuKbdProps: string;
    menuKbdDuplicate: string;
    menuKbdUp: string;
    menuKbdDown: string;
    menuKbdCopy: string;
    menuKbdDelete: string;
    targetLabel: string;
    scratch: string;
    ...
    paletteGroupMarketing: string;
    paletteGroupHero: string;
    paletteGroupAuth: string;
    ...
    marketingHeroSplit: string;
    marketingHeroMinimal: string;
    marketingSplitAuth: string;
    marketingCredentials: string;
    marketingOauth: string;
    marketingTestimonial: string;
    marketingFeatureGrid: string;
    marketingBridge: string;
    ...
    imageLoading: string;
    imageUpload: string;
    inspectorI18nKey: string;
    inspectorBackground: string;
    inspectorPalette: string;
    inspectorGradient: string;
    inspectorRadius: string;
    inspectorFieldWidth: string;
    inspectorFieldWidthHint: string;
    radiusNone: string;
    radiusMedium: string;
    radiusFull: string;
    swatchPaper: string;
    ...
    aiHints: {
      ...
      'accent-panel': string;
      'match-hero': string;
      'bridge-divider': string;
      'tighten-form': string;
    };
    connectedDb: string;
    dbUnknown: string;
    openTranslations: string;
    generatePage: string;
    generatePagePrompt: string;
    ...
    addScript: string;
    sandboxTitle: string;
    createI18nKey: string;
    createI18nValue: string;
    createI18nAction: string;
    inspectorAdvancedHint: string;
  };
  cmsTranslations: {
    title: string;
    subtitle: string;
  ...
  settings: {
    ...
    catalogFormatJson: string;
    catalogFormatJs: string;
    catalogSource: string;
    catalogSave: string;
    translationsTable: string;
    translationsJson: string;
    translationsSearch: string;
    translationsImport: string;
    translationsExport: string;
    translationsAddLocale: string;
    translationsSource: string;
    translationsKeys: string;
    translationsDone: string;
    translationsMissing: string;
    translationsSuggested: string;
    translationsAiAll: string;
    translationsAiPrepare: string;
    translationsAiBanner: string;
    translationsAiNotReady: string;
    translationsColKey: string;
    translationsColSource: string;
    translationsColTarget: string;
    translationsColStatus: string;
    translationsStatusDone: string;
    translationsStatusMissing: string;
    ...
    password: string;
    avatar: string;
    showDeveloperPage: string;
    showDeveloperPageHint: string;
    siteName: string;
    seoTitle: string;
    seoDescription: string;
    siteLogo: string;
    ...
    publicNavProduct: string;
    publicNavDocs: string;
    publicNavPlans: string;
    publicNavDemo: string;
    publicNavChangelog: string;
    publicNavStatus: string;
    publicNavBlog: string;
    publicNavGuides: string;
    publicNavApi: string;
    publicNavAskAi: string;
