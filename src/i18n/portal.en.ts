...
export const en: Messages = {
  ...
  plans: {
    ...
    standardFeatStage: 'Visual Stage canvas for sections, grids, and widgets',
    ...
    aiName: 'AI',
    aiLead: 'Standard plus auto-translate catalogs and inline AI assist on Stage.',
    aiFeatStandard: 'Everything in Standard',
    aiFeatTranslate: 'One-click auto-translate catalogs to supported locales',
    aiFeatSuggest: 'Inline AI suggestions on Stage as you build',
