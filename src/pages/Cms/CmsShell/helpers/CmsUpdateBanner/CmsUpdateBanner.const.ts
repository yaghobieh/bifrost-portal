...
export const CMS_UPDATE_SNACKBAR_CLOSE_ON_OUTSIDE = false;
export const CMS_UPDATE_SNACKBAR_OFFSET_Y = NUMBER_TWENTY_FOUR;
export const CMS_UPDATE_SNACKBAR_ANCHOR = {
  vertical: 'top',
  horizontal: 'center',
} as const;
